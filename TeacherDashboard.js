...
const TeacherDashboard = () => {
  ...
  // Function to update teachers list after deletion
  ...
  // Simulating fetching teachers data (can be replaced with API call)
  useEffect(() => {
    const fetchTeachers = () => {
      // Mock teacher data
      const teacherData = [
    ...
    fetchTeachers(); // Call fetch on component mount
  }, []);
